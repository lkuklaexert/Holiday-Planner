        ...
        <div className="mx-auto max-w-[1600px] space-y-4">
          ...
          {activeView === "planner" && (
            <PlannerPage
              ...
              holidayWindowFilter={holidayWindowFilter}
              setHolidayWindowFilter={setHolidayWindowFilter}
              scrollCalendarToToday={scrollCalendarToToday}
              ...
              employeeDepartmentNames={employeeDepartmentNames}
              bankHolidayMap={bankHolidayMap}
              leaveTypeColorClass={leaveTypeColorClass}
              isStandardBooking={isStandardBooking}
              year={year}
            />
          )}
          <ConfirmDialog
